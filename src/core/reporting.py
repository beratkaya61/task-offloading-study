...
def _aggregate_results(df):
    ...
    agg_map = {
        ...
        "metric_deadline_miss_ratio": ["mean", "std"],
        "metric_avg_reward": ["mean", "std"],
        "metric_avg_latency": ["mean", "std"],
        "metric_p95_latency": ["mean", "std"],
        "metric_p99_latency": ["mean", "std"],
        "metric_avg_energy": ["mean", "std"],
        "metric_energy_per_success": ["mean", "std"],
        "metric_jitter": ["mean", "std"],
        "metric_avg_queue_delay": ["mean", "std"],
        "metric_battery_depletion_rate": ["mean", "std"],
        "metric_partial_offload_ratio": ["mean", "std"],
        "metric_decision_overhead_ms": ["mean", "std"],
        "metric_qoe": ["mean", "std"],
