...
def load_retraining_config(config_path="configs/phase_5/synthetic_rl_retraining.yaml"):
    with open(config_path, "r", encoding="utf-8") as handle:
        return yaml.safe_load(handle)


def run_synthetic_rl_retraining(config_path="configs/phase_5/synthetic_rl_retraining.yaml"):
    ...
    summarize_logs(results_dir="results/phase_5/metrics", output_table=report_path)
