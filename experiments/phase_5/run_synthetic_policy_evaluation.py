...
def load_policy_evaluation_config(config_path="configs/phase_5/synthetic_policy_evaluation.yaml"):
...
def run_policy_evaluation():
    ...
    csv_path = output_cfg.get("csv_path", "results/phase_5/metrics/synthetic/policy_evaluation/synthetic_policy_evaluation.csv")
