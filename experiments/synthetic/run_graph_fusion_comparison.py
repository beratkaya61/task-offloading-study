...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config",
        default="configs/synthetic/graph_supervised_pretraining.yaml",
    ...
    parser.add_argument(
        "--csv",
        default="results/raw/synthetic/debug/graph_fusion_comparison.csv",
    ...
    parser.add_argument("--write_csv", action="store_true", help="Write optional raw comparison CSV files")
