...
def run_pretrained_checkpoint_evaluation(
    sensitivity_csv_path: str = 'results/phase_7/metrics/synthetic/teacher_policy_sensitivity/teacher_policy_sensitivity.csv',
    training_config_path: str = 'configs/phase_7/staged_training_comparison.yaml',
    output_csv_path: str = 'results/phase_7/metrics/synthetic/teacher_policy_sensitivity/pretrained_checkpoint_evaluation.csv',
    ...
    temp_eval_csv = Path('results/phase_7/metrics/synthetic/teacher_policy_sensitivity/_tmp_pretrained_only_eval.csv')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--sensitivity-csv', default='results/phase_7/metrics/synthetic/teacher_policy_sensitivity/teacher_policy_sensitivity.csv')
    parser.add_argument('--training-config', default='configs/phase_7/staged_training_comparison.yaml')
    parser.add_argument('--output-csv', default='results/phase_7/metrics/synthetic/teacher_policy_sensitivity/pretrained_checkpoint_evaluation.csv')
