...
def load_config(config_path='configs/phase_7/staged_training_comparison.yaml'):
...
def run_staged_training_comparison(config_path='configs/phase_7/staged_training_comparison.yaml', report_only=False, batch_id=None):
    ...
    base_config = training_cfg.get('base_config', 'configs/phase_5/synthetic_rl_training.yaml')
    ...
    final_csv = output_cfg.get('final_csv', 'results/phase_7/metrics/synthetic/teacher_policy_sensitivity/contextual_reward_aligned/staged_training_comparison.csv')
    progress_csv = output_cfg.get('progress_csv', 'results/phase_7/metrics/synthetic/teacher_policy_sensitivity/contextual_reward_aligned/staged_training_progress.csv')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config-path', default='configs/phase_7/staged_training_comparison.yaml')
