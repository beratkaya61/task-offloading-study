...
from experiments.phase_7.run_staged_training_comparison import (
...
def _write_markdown(report_path: Path, rows: List[Dict[str, object]]) -> None:
    ...
    for row in rows:
        ...
        lines.extend([
            ...
            f"- Teacher config seti: `configs/phase_7/teacher_policies/supervised_pretraining_{slug}.yaml` ve `configs/phase_7/teacher_policies/staged_training_{slug}.yaml`",
...
def run_teacher_policy_sensitivity(
    pretrain_config_path: str = "configs/phase_7/supervised_pretraining.yaml",
    staged_config_path: str = "configs/phase_7/staged_training_comparison.yaml",
    dataset_csv_path: str = "results/phase_7/metrics/synthetic/pretraining/oracle_label_dataset.csv",
) -> Dict[str, str]:
    ...
    result_root = Path("results/phase_7/metrics/synthetic/teacher_policy_sensitivity")
    doc_root = Path("v2_docs/phase_7")
    config_root = Path("configs/phase_7/teacher_policies")
    ...
    for teacher_policy in TEACHER_POLICIES:
        ...
        if _teacher_run_complete(result_root, doc_root, slug):
            ...
            pretrain_cfg["output"]["metrics_csv"] = f"results/phase_7/metrics/synthetic/teacher_policy_sensitivity/{slug}/supervised_pretraining_metrics.csv"
            ...
            staged_cfg["output"]["final_csv"] = f"results/phase_7/metrics/synthetic/teacher_policy_sensitivity/{slug}/staged_training_comparison.csv"
            staged_cfg["output"]["progress_csv"] = f"results/phase_7/metrics/synthetic/teacher_policy_sensitivity/{slug}/staged_training_progress.csv"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--pretrain-config", default="configs/phase_7/supervised_pretraining.yaml")
    parser.add_argument("--staged-config", default="configs/phase_7/staged_training_comparison.yaml")
    parser.add_argument("--dataset-csv", default="results/phase_7/metrics/synthetic/pretraining/oracle_label_dataset.csv")
